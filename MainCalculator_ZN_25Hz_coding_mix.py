...
def main_cal(path1, path2, path3):
    ...
    head_list = config_headlist_ZN_25Hz_coding_mix()
    ...
    for _, df_input_row in df_input.iterrows():
        ...
        # 电码化
        row_data.config_25Hz_coding_device(pd_read_flag=flag)
        ...
        md = PreModel_ZN_25Hz_coding_mix(parameter=para)
